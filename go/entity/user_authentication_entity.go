...
type UserAuthenticationEntity struct {
	name    string
...
func NewUserAuthenticationEntity(client *core.Hook0SDK, entopts map[string]any) *UserAuthenticationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserAuthenticationEntity) GetName() string { return e.name }
...
func (e *UserAuthenticationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserAuthenticationEntity) Deleted() bool {
	return e.deleted
}


func (e *UserAuthenticationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserAuthenticationEntity(e.client, opts)
}

func (e *UserAuthenticationEntity) Data(args ...any) any {
...
func (e *UserAuthenticationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserAuthentication; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserAuthenticationEntity) DataTyped(data ...UserAuthentication) UserAuthentication {
	if len(data) > 0 {
		return typedFrom[UserAuthentication](e.Data(asMap(data[0])))
	}
	return typedFrom[UserAuthentication](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserAuthentication (all fields
// optional at the wire level).
func (e *UserAuthenticationEntity) MatchTyped(match ...UserAuthentication) UserAuthentication {
	if len(match) > 0 {
		return typedFrom[UserAuthentication](e.Match(asMap(match[0])))
	}
	return typedFrom[UserAuthentication](e.Match())
}
...
func (e *UserAuthenticationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserAuthenticationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *UserAuthenticationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *UserAuthenticationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserAuthenticationCreateData and returns an UserAuthentication. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UserAuthenticationEntity) CreateTyped(reqdata UserAuthenticationCreateData, ctrl map[string]any) (UserAuthentication, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return UserAuthentication{}, err
	}
	return typedFrom[UserAuthentication](res), nil
}



func (e *UserAuthenticationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserAuthenticationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserAuthenticationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
