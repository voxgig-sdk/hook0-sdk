...
func NewProblemEntity(client *core.Hook0SDK, entopts map[string]any) *ProblemEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProblemEntity) GetName() string { return e.name }
...
func (e *ProblemEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProblemEntity) Deleted() bool {
	return e.deleted
}


func (e *ProblemEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProblemEntity(e.client, opts)
}

func (e *ProblemEntity) Data(args ...any) any {
...
func (e *ProblemEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Problem; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProblemEntity) DataTyped(data ...Problem) Problem {
	if len(data) > 0 {
		return typedFrom[Problem](e.Data(asMap(data[0])))
	}
	return typedFrom[Problem](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Problem (all fields
// optional at the wire level).
func (e *ProblemEntity) MatchTyped(match ...Problem) Problem {
	if len(match) > 0 {
		return typedFrom[Problem](e.Match(asMap(match[0])))
	}
	return typedFrom[Problem](e.Match())
}
...
func (e *ProblemEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProblemEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ProblemEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProblemListMatch and returns []Problem. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ProblemEntity) ListTyped(reqmatch ProblemListMatch, ctrl map[string]any) ([]Problem, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Problem](res), nil
}



func (e *ProblemEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProblemEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProblemEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ProblemEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
