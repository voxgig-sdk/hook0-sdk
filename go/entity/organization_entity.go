...
func NewOrganizationEntity(client *core.Hook0SDK, entopts map[string]any) *OrganizationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OrganizationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OrganizationEntity) Deleted() bool {
	return e.deleted
}
...
func (e *OrganizationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// OrganizationCreateData and returns an Organization. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *OrganizationEntity) CreateTyped(reqdata OrganizationCreateData, ctrl map[string]any) (Organization, error) {
...
func (e *OrganizationEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// OrganizationUpdateData and returns an Organization. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *OrganizationEntity) UpdateTyped(reqdata OrganizationUpdateData, ctrl map[string]any) (Organization, error) {
...
func (e *OrganizationEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// OrganizationRemoveMatch and returns an Organization. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *OrganizationEntity) RemoveTyped(reqmatch OrganizationRemoveMatch, ctrl map[string]any) (Organization, error) {
