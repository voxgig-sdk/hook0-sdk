...
func NewEventTypeEntity(client *core.Hook0SDK, entopts map[string]any) *EventTypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EventTypeEntity) GetName() string { return e.name }
...
func (e *EventTypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EventTypeEntity) Deleted() bool {
	return e.deleted
}


func (e *EventTypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEventTypeEntity(e.client, opts)
}

func (e *EventTypeEntity) Data(args ...any) any {
...
func (e *EventTypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EventType; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EventTypeEntity) DataTyped(data ...EventType) EventType {
	if len(data) > 0 {
		return typedFrom[EventType](e.Data(asMap(data[0])))
	}
	return typedFrom[EventType](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EventType (all fields
// optional at the wire level).
func (e *EventTypeEntity) MatchTyped(match ...EventType) EventType {
	if len(match) > 0 {
		return typedFrom[EventType](e.Match(asMap(match[0])))
	}
	return typedFrom[EventType](e.Match())
}
...
func (e *EventTypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EventTypeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EventTypeLoadMatch and returns an EventType. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EventTypeEntity) LoadTyped(reqmatch EventTypeLoadMatch, ctrl map[string]any) (EventType, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return EventType{}, err
	}
	return typedFrom[EventType](res), nil
}




func (e *EventTypeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// EventTypeListMatch and returns []EventType. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EventTypeEntity) ListTyped(reqmatch EventTypeListMatch, ctrl map[string]any) ([]EventType, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[EventType](res), nil
}




func (e *EventTypeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// EventTypeCreateData and returns an EventType. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EventTypeEntity) CreateTyped(reqdata EventTypeCreateData, ctrl map[string]any) (EventType, error) {
...
func (e *EventTypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EventTypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EventTypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
