...
func NewRevokeEntity(client *core.Hook0SDK, entopts map[string]any) *RevokeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RevokeEntity) GetName() string { return e.name }
...
func (e *RevokeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RevokeEntity) Deleted() bool {
	return e.deleted
}


func (e *RevokeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRevokeEntity(e.client, opts)
}

func (e *RevokeEntity) Data(args ...any) any {
...
func (e *RevokeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Revoke; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RevokeEntity) DataTyped(data ...Revoke) Revoke {
	if len(data) > 0 {
		return typedFrom[Revoke](e.Data(asMap(data[0])))
	}
	return typedFrom[Revoke](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Revoke (all fields
// optional at the wire level).
func (e *RevokeEntity) MatchTyped(match ...Revoke) Revoke {
	if len(match) > 0 {
		return typedFrom[Revoke](e.Match(asMap(match[0])))
	}
	return typedFrom[Revoke](e.Match())
}
...
func (e *RevokeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RevokeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *RevokeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RevokeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RevokeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *RevokeEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RevokeRemoveMatch and returns an Revoke. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *RevokeEntity) RemoveTyped(reqmatch RevokeRemoveMatch, ctrl map[string]any) (Revoke, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Revoke{}, err
	}
	return typedFrom[Revoke](res), nil
}



func (e *RevokeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
