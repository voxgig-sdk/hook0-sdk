...
type UserInvitationEntity struct {
	name    string
...
func NewUserInvitationEntity(client *core.Hook0SDK, entopts map[string]any) *UserInvitationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserInvitationEntity) GetName() string { return e.name }
...
func (e *UserInvitationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UserInvitationEntity) Deleted() bool {
	return e.deleted
}


func (e *UserInvitationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUserInvitationEntity(e.client, opts)
}

func (e *UserInvitationEntity) Data(args ...any) any {
...
func (e *UserInvitationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UserInvitation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UserInvitationEntity) DataTyped(data ...UserInvitation) UserInvitation {
	if len(data) > 0 {
		return typedFrom[UserInvitation](e.Data(asMap(data[0])))
	}
	return typedFrom[UserInvitation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UserInvitation (all fields
// optional at the wire level).
func (e *UserInvitationEntity) MatchTyped(match ...UserInvitation) UserInvitation {
	if len(match) > 0 {
		return typedFrom[UserInvitation](e.Match(asMap(match[0])))
	}
	return typedFrom[UserInvitation](e.Match())
}
...
func (e *UserInvitationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UserInvitationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *UserInvitationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *UserInvitationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UserInvitationCreateData and returns an UserInvitation. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UserInvitationEntity) CreateTyped(reqdata UserInvitationCreateData, ctrl map[string]any) (UserInvitation, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return UserInvitation{}, err
	}
	return typedFrom[UserInvitation](res), nil
}



func (e *UserInvitationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UserInvitationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UserInvitationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
