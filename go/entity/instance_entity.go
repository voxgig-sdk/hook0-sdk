...
func NewInstanceEntity(client *core.Hook0SDK, entopts map[string]any) *InstanceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InstanceEntity) GetName() string { return e.name }
...
func (e *InstanceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InstanceEntity) Deleted() bool {
	return e.deleted
}


func (e *InstanceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInstanceEntity(e.client, opts)
}

func (e *InstanceEntity) Data(args ...any) any {
...
func (e *InstanceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Instance; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InstanceEntity) DataTyped(data ...Instance) Instance {
	if len(data) > 0 {
		return typedFrom[Instance](e.Data(asMap(data[0])))
	}
	return typedFrom[Instance](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Instance (all fields
// optional at the wire level).
func (e *InstanceEntity) MatchTyped(match ...Instance) Instance {
	if len(match) > 0 {
		return typedFrom[Instance](e.Match(asMap(match[0])))
	}
	return typedFrom[Instance](e.Match())
}
...
func (e *InstanceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InstanceEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InstanceLoadMatch and returns an Instance. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *InstanceEntity) LoadTyped(reqmatch InstanceLoadMatch, ctrl map[string]any) (Instance, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Instance{}, err
	}
	return typedFrom[Instance](res), nil
}



func (e *InstanceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *InstanceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *InstanceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InstanceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InstanceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
