...
func NewHook0Entity(client *core.Hook0SDK, entopts map[string]any) *Hook0Entity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *Hook0Entity) GetName() string { return e.name }
...
func (e *Hook0Entity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *Hook0Entity) Deleted() bool {
	return e.deleted
}


func (e *Hook0Entity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHook0Entity(e.client, opts)
}

func (e *Hook0Entity) Data(args ...any) any {
...
func (e *Hook0Entity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Hook0; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *Hook0Entity) DataTyped(data ...Hook0) Hook0 {
	if len(data) > 0 {
		return typedFrom[Hook0](e.Data(asMap(data[0])))
	}
	return typedFrom[Hook0](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Hook0 (all fields
// optional at the wire level).
func (e *Hook0Entity) MatchTyped(match ...Hook0) Hook0 {
	if len(match) > 0 {
		return typedFrom[Hook0](e.Match(asMap(match[0])))
	}
	return typedFrom[Hook0](e.Match())
}
...
func (e *Hook0Entity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *Hook0Entity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *Hook0Entity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// Hook0ListMatch and returns []Hook0. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *Hook0Entity) ListTyped(reqmatch Hook0ListMatch, ctrl map[string]any) ([]Hook0, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Hook0](res), nil
}



func (e *Hook0Entity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *Hook0Entity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *Hook0Entity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *Hook0Entity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
