...
func NewRegistrationEntity(client *core.Hook0SDK, entopts map[string]any) *RegistrationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RegistrationEntity) GetName() string { return e.name }
...
func (e *RegistrationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RegistrationEntity) Deleted() bool {
	return e.deleted
}


func (e *RegistrationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRegistrationEntity(e.client, opts)
}

func (e *RegistrationEntity) Data(args ...any) any {
...
func (e *RegistrationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *RegistrationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RegistrationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *RegistrationEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *RegistrationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RegistrationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RegistrationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
