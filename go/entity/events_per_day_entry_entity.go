...
type EventsPerDayEntryEntity struct {
	name    string
...
func NewEventsPerDayEntryEntity(client *core.Hook0SDK, entopts map[string]any) *EventsPerDayEntryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EventsPerDayEntryEntity) GetName() string { return e.name }
...
func (e *EventsPerDayEntryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EventsPerDayEntryEntity) Deleted() bool {
	return e.deleted
}


func (e *EventsPerDayEntryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEventsPerDayEntryEntity(e.client, opts)
}

func (e *EventsPerDayEntryEntity) Data(args ...any) any {
...
func (e *EventsPerDayEntryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EventsPerDayEntry; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EventsPerDayEntryEntity) DataTyped(data ...EventsPerDayEntry) EventsPerDayEntry {
	if len(data) > 0 {
		return typedFrom[EventsPerDayEntry](e.Data(asMap(data[0])))
	}
	return typedFrom[EventsPerDayEntry](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EventsPerDayEntry (all fields
// optional at the wire level).
func (e *EventsPerDayEntryEntity) MatchTyped(match ...EventsPerDayEntry) EventsPerDayEntry {
	if len(match) > 0 {
		return typedFrom[EventsPerDayEntry](e.Match(asMap(match[0])))
	}
	return typedFrom[EventsPerDayEntry](e.Match())
}
...
func (e *EventsPerDayEntryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EventsPerDayEntryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *EventsPerDayEntryEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EventsPerDayEntryListMatch and returns []EventsPerDayEntry. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EventsPerDayEntryEntity) ListTyped(reqmatch EventsPerDayEntryListMatch, ctrl map[string]any) ([]EventsPerDayEntry, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[EventsPerDayEntry](res), nil
}



func (e *EventsPerDayEntryEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EventsPerDayEntryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EventsPerDayEntryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EventsPerDayEntryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
