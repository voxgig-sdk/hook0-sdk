...
type ApplicationsManagementEntity struct {
	name    string
...
func NewApplicationsManagementEntity(client *core.Hook0SDK, entopts map[string]any) *ApplicationsManagementEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &ApplicationsManagementEntity{
...
func (e *ApplicationsManagementEntity) GetName() string { return e.name }
...
func (e *ApplicationsManagementEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApplicationsManagementEntity) Deleted() bool {
	return e.deleted
}


func (e *ApplicationsManagementEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewApplicationsManagementEntity(e.client, opts)
}

func (e *ApplicationsManagementEntity) Data(args ...any) any {
...
func (e *ApplicationsManagementEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ApplicationsManagement; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ApplicationsManagementEntity) DataTyped(data ...ApplicationsManagement) ApplicationsManagement {
	if len(data) > 0 {
		return typedFrom[ApplicationsManagement](e.Data(asMap(data[0])))
	}
	return typedFrom[ApplicationsManagement](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ApplicationsManagement (all fields
// optional at the wire level).
func (e *ApplicationsManagementEntity) MatchTyped(match ...ApplicationsManagement) ApplicationsManagement {
	if len(match) > 0 {
		return typedFrom[ApplicationsManagement](e.Match(asMap(match[0])))
	}
	return typedFrom[ApplicationsManagement](e.Match())
}
...
func (e *ApplicationsManagementEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ApplicationsManagementEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ApplicationsManagementEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ApplicationsManagementEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ApplicationsManagementEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ApplicationsManagementEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ApplicationsManagementRemoveMatch and returns an ApplicationsManagement. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ApplicationsManagementEntity) RemoveTyped(reqmatch ApplicationsManagementRemoveMatch, ctrl map[string]any) (ApplicationsManagement, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return ApplicationsManagement{}, err
	}
	return typedFrom[ApplicationsManagement](res), nil
}



func (e *ApplicationsManagementEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
