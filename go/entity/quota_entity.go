...
func NewQuotaEntity(client *core.Hook0SDK, entopts map[string]any) *QuotaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *QuotaEntity) GetName() string { return e.name }
...
func (e *QuotaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *QuotaEntity) Deleted() bool {
	return e.deleted
}


func (e *QuotaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewQuotaEntity(e.client, opts)
}

func (e *QuotaEntity) Data(args ...any) any {
...
func (e *QuotaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Quota; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *QuotaEntity) DataTyped(data ...Quota) Quota {
	if len(data) > 0 {
		return typedFrom[Quota](e.Data(asMap(data[0])))
	}
	return typedFrom[Quota](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Quota (all fields
// optional at the wire level).
func (e *QuotaEntity) MatchTyped(match ...Quota) Quota {
	if len(match) > 0 {
		return typedFrom[Quota](e.Match(asMap(match[0])))
	}
	return typedFrom[Quota](e.Match())
}
...
func (e *QuotaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *QuotaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// QuotaLoadMatch and returns an Quota. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *QuotaEntity) LoadTyped(reqmatch QuotaLoadMatch, ctrl map[string]any) (Quota, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Quota{}, err
	}
	return typedFrom[Quota](res), nil
}



func (e *QuotaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *QuotaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *QuotaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *QuotaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *QuotaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
