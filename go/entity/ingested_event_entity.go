...
type IngestedEventEntity struct {
	name    string
...
func NewIngestedEventEntity(client *core.Hook0SDK, entopts map[string]any) *IngestedEventEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *IngestedEventEntity) GetName() string { return e.name }
...
func (e *IngestedEventEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *IngestedEventEntity) Deleted() bool {
	return e.deleted
}


func (e *IngestedEventEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewIngestedEventEntity(e.client, opts)
}

func (e *IngestedEventEntity) Data(args ...any) any {
...
func (e *IngestedEventEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an IngestedEvent; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *IngestedEventEntity) DataTyped(data ...IngestedEvent) IngestedEvent {
	if len(data) > 0 {
		return typedFrom[IngestedEvent](e.Data(asMap(data[0])))
	}
	return typedFrom[IngestedEvent](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through IngestedEvent (all fields
// optional at the wire level).
func (e *IngestedEventEntity) MatchTyped(match ...IngestedEvent) IngestedEvent {
	if len(match) > 0 {
		return typedFrom[IngestedEvent](e.Match(asMap(match[0])))
	}
	return typedFrom[IngestedEvent](e.Match())
}
...
func (e *IngestedEventEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *IngestedEventEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *IngestedEventEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *IngestedEventEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// IngestedEventCreateData and returns an IngestedEvent. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *IngestedEventEntity) CreateTyped(reqdata IngestedEventCreateData, ctrl map[string]any) (IngestedEvent, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return IngestedEvent{}, err
	}
	return typedFrom[IngestedEvent](res), nil
}



func (e *IngestedEventEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *IngestedEventEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *IngestedEventEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
