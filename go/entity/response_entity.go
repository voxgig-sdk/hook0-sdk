...
func NewResponseEntity(client *core.Hook0SDK, entopts map[string]any) *ResponseEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ResponseEntity) GetName() string { return e.name }
...
func (e *ResponseEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ResponseEntity) Deleted() bool {
	return e.deleted
}


func (e *ResponseEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewResponseEntity(e.client, opts)
}

func (e *ResponseEntity) Data(args ...any) any {
...
func (e *ResponseEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Response; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ResponseEntity) DataTyped(data ...Response) Response {
	if len(data) > 0 {
		return typedFrom[Response](e.Data(asMap(data[0])))
	}
	return typedFrom[Response](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Response (all fields
// optional at the wire level).
func (e *ResponseEntity) MatchTyped(match ...Response) Response {
	if len(match) > 0 {
		return typedFrom[Response](e.Match(asMap(match[0])))
	}
	return typedFrom[Response](e.Match())
}
...
func (e *ResponseEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ResponseEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ResponseLoadMatch and returns an Response. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ResponseEntity) LoadTyped(reqmatch ResponseLoadMatch, ctrl map[string]any) (Response, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Response{}, err
	}
	return typedFrom[Response](res), nil
}



func (e *ResponseEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ResponseEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ResponseEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ResponseEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ResponseEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
