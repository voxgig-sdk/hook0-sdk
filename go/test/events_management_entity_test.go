...
func TestEventsManagementEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		eventsManagementRef01Data = core.ToMapAny(eventsManagementRef01DataResult)
...
func events_managementBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("HOOK__TEST_EVENTS_MANAGEMENT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["HOOK__TEST_EVENTS_MANAGEMENT_ENTID"])
