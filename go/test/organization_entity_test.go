...
func TestOrganizationEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		organizationRef01Data = core.ToMapAny(organizationRef01DataResult)
		...
		organizationRef01ResdataUp0 := core.ToMapAny(organizationRef01ResdataUp0Result)
...
func organizationBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("HOOK__TEST_ORGANIZATION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["HOOK__TEST_ORGANIZATION_ENTID"])
