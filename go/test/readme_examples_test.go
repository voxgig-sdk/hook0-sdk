...
const testSeed = `map[string]any{"entity": map[string]any{"application": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "application_secret": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "applications_management": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "events_management": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "events_per_day_entry": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "health": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "hook0": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ingested_event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "instance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "login": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "organization": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "organization_edit_role": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "problem": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "quota": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "registration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "request_attempt": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "response": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "revoke": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "service_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "subscription": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_authentication": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user_invitation": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
