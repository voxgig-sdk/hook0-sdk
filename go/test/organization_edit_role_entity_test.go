...
func TestOrganizationEditRoleEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		organizationEditRoleRef01ResdataUp0 := core.ToMapAny(organizationEditRoleRef01ResdataUp0Result)
...
func organization_edit_roleBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("HOOK__TEST_ORGANIZATION_EDIT_ROLE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["HOOK__TEST_ORGANIZATION_EDIT_ROLE_ENTID"])
