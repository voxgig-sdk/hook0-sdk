...
local SubscriptionEntity = {}
SubscriptionEntity.__index = SubscriptionEntity


function SubscriptionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SubscriptionEntity)
  self._name = "subscription"
  self._client = client
...
function SubscriptionEntity:get_name()
  return self._name
end


function SubscriptionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SubscriptionEntity.new(self._client, opts)
end
...
function SubscriptionEntity:mark_deleted()
  self._deleted = true
end


function SubscriptionEntity:deleted()
  return true == self._deleted
end


function SubscriptionEntity:data_set(args)
  if args ~= nil then
...
function SubscriptionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SubscriptionEntity:match_set(args)
  if args ~= nil then
...
function SubscriptionEntity:match_get()
...
function SubscriptionEntity:stream(action, args, callopts)
...
---@param reqmatch SubscriptionLoadMatch
---@param ctrl? table
---@return Subscription
---@return string? err
function SubscriptionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch SubscriptionListMatch
---@param ctrl? table
---@return Subscription[]
---@return string? err
function SubscriptionEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata SubscriptionCreateData
---@param ctrl? table
---@return Subscription
---@return string? err
function SubscriptionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata SubscriptionUpdateData
---@param ctrl? table
---@return Subscription
---@return string? err
function SubscriptionEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch SubscriptionRemoveMatch
---@param ctrl? table
---@return Subscription
---@return string? err
function SubscriptionEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function SubscriptionEntity:_run_op(ctx, post_done)
  local utility = self._utility
