...
local RequestAttemptEntity = {}
RequestAttemptEntity.__index = RequestAttemptEntity


function RequestAttemptEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RequestAttemptEntity)
  self._name = "request_attempt"
  self._client = client
...
function RequestAttemptEntity:get_name()
  return self._name
end


function RequestAttemptEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RequestAttemptEntity.new(self._client, opts)
end
...
function RequestAttemptEntity:mark_deleted()
  self._deleted = true
end


function RequestAttemptEntity:deleted()
  return true == self._deleted
end


function RequestAttemptEntity:data_set(args)
  if args ~= nil then
...
function RequestAttemptEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RequestAttemptEntity:match_set(args)
  if args ~= nil then
...
function RequestAttemptEntity:match_get()
...
function RequestAttemptEntity:stream(action, args, callopts)
...
---@param reqmatch RequestAttemptLoadMatch
---@param ctrl? table
---@return RequestAttempt
---@return string? err
function RequestAttemptEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch RequestAttemptListMatch
---@param ctrl? table
---@return RequestAttempt[]
---@return string? err
function RequestAttemptEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function RequestAttemptEntity:_run_op(ctx, post_done)
  local utility = self._utility
