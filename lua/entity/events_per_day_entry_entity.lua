...
local EventsPerDayEntryEntity = {}
EventsPerDayEntryEntity.__index = EventsPerDayEntryEntity


function EventsPerDayEntryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EventsPerDayEntryEntity)
  self._name = "events_per_day_entry"
  self._client = client
...
function EventsPerDayEntryEntity:get_name()
  return self._name
end


function EventsPerDayEntryEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EventsPerDayEntryEntity.new(self._client, opts)
end
...
function EventsPerDayEntryEntity:mark_deleted()
  self._deleted = true
end


function EventsPerDayEntryEntity:deleted()
  return true == self._deleted
end


function EventsPerDayEntryEntity:data_set(args)
  if args ~= nil then
...
function EventsPerDayEntryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EventsPerDayEntryEntity:match_set(args)
  if args ~= nil then
...
function EventsPerDayEntryEntity:match_get()
...
function EventsPerDayEntryEntity:stream(action, args, callopts)
...
---@param reqmatch EventsPerDayEntryListMatch
---@param ctrl? table
---@return EventsPerDayEntry[]
---@return string? err
function EventsPerDayEntryEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function EventsPerDayEntryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return EventsPerDayEntryEntity
