...
local ApplicationSecretEntity = {}
ApplicationSecretEntity.__index = ApplicationSecretEntity


function ApplicationSecretEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApplicationSecretEntity)
  self._name = "application_secret"
  self._client = client
...
function ApplicationSecretEntity:get_name()
  return self._name
end


function ApplicationSecretEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ApplicationSecretEntity.new(self._client, opts)
end
...
function ApplicationSecretEntity:mark_deleted()
  self._deleted = true
end


function ApplicationSecretEntity:deleted()
  return true == self._deleted
end


function ApplicationSecretEntity:data_set(args)
  if args ~= nil then
...
function ApplicationSecretEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApplicationSecretEntity:match_set(args)
  if args ~= nil then
...
function ApplicationSecretEntity:match_get()
...
function ApplicationSecretEntity:stream(action, args, callopts)
...
---@param reqmatch ApplicationSecretListMatch
---@param ctrl? table
---@return ApplicationSecret[]
---@return string? err
function ApplicationSecretEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApplicationSecretCreateData
---@param ctrl? table
---@return ApplicationSecret
---@return string? err
function ApplicationSecretEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ApplicationSecretUpdateData
---@param ctrl? table
---@return ApplicationSecret
---@return string? err
function ApplicationSecretEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ApplicationSecretEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApplicationSecretEntity
