...
local EventsManagementEntity = {}
EventsManagementEntity.__index = EventsManagementEntity


function EventsManagementEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, EventsManagementEntity)
  self._name = "events_management"
  self._client = client
...
function EventsManagementEntity:get_name()
  return self._name
end


function EventsManagementEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return EventsManagementEntity.new(self._client, opts)
end
...
function EventsManagementEntity:mark_deleted()
  self._deleted = true
end


function EventsManagementEntity:deleted()
  return true == self._deleted
end


function EventsManagementEntity:data_set(args)
  if args ~= nil then
...
function EventsManagementEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function EventsManagementEntity:match_set(args)
  if args ~= nil then
...
function EventsManagementEntity:match_get()
...
function EventsManagementEntity:stream(action, args, callopts)
...
---@param reqmatch EventsManagementListMatch
---@param ctrl? table
---@return EventsManagement[]
---@return string? err
function EventsManagementEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch EventsManagementRemoveMatch
---@param ctrl? table
---@return EventsManagement
---@return string? err
function EventsManagementEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function EventsManagementEntity:_run_op(ctx, post_done)
  local utility = self._utility
