...
local ServiceTokenEntity = {}
ServiceTokenEntity.__index = ServiceTokenEntity


function ServiceTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ServiceTokenEntity)
  self._name = "service_token"
  self._client = client
...
function ServiceTokenEntity:get_name()
  return self._name
end


function ServiceTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ServiceTokenEntity.new(self._client, opts)
end
...
function ServiceTokenEntity:mark_deleted()
  self._deleted = true
end


function ServiceTokenEntity:deleted()
  return true == self._deleted
end


function ServiceTokenEntity:data_set(args)
  if args ~= nil then
...
function ServiceTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ServiceTokenEntity:match_set(args)
  if args ~= nil then
...
function ServiceTokenEntity:match_get()
...
function ServiceTokenEntity:stream(action, args, callopts)
...
---@param reqmatch ServiceTokenLoadMatch
---@param ctrl? table
---@return ServiceToken
---@return string? err
function ServiceTokenEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ServiceTokenListMatch
---@param ctrl? table
---@return ServiceToken[]
---@return string? err
function ServiceTokenEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ServiceTokenCreateData
---@param ctrl? table
---@return ServiceToken
---@return string? err
function ServiceTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ServiceTokenUpdateData
---@param ctrl? table
---@return ServiceToken
---@return string? err
function ServiceTokenEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ServiceTokenRemoveMatch
---@param ctrl? table
---@return ServiceToken
---@return string? err
function ServiceTokenEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ServiceTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
