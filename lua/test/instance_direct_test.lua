...
describe("InstanceDirect", function()
  it("should direct-load-instance", function()
    local setup = instance_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-instance", setup.live and "live" or "unit")
...
function instance_direct_setup(mockres)
