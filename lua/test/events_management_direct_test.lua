...
describe("EventsManagementDirect", function()
  it("should direct-list-events_management", function()
    local setup = events_management_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-events_management", setup.live and "live" or "unit")
...
function events_management_direct_setup(mockres)
