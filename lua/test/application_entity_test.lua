...
describe("ApplicationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set HOOK0_TEST_APPLICATION_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    local application_ref01_resdata_up0 = helpers.to_map(type(application_ref01_resdata_up0_result) == 'table' and application_ref01_resdata_up0_result.data_get and application_ref01_resdata_up0_result:data_get() or application_ref01_resdata_up0_result)
...
function application_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("HOOK0_TEST_APPLICATION_ENTID")
