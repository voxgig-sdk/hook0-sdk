...
describe("Hook0Direct", function()
  it("should direct-list-hook0", function()
    local setup = hook0_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-hook0", setup.live and "live" or "unit")
...
function hook0_direct_setup(mockres)
