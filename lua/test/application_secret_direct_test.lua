...
describe("ApplicationSecretDirect", function()
  it("should direct-list-application_secret", function()
    local setup = application_secret_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-application_secret", setup.live and "live" or "unit")
...
function application_secret_direct_setup(mockres)
