...
describe("SubscriptionDirect", function()
  it("should direct-list-subscription", function()
    local setup = subscription_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-subscription", setup.live and "live" or "unit")
  ...
  it("should direct-load-subscription", function()
    local setup = subscription_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-subscription", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function subscription_direct_setup(mockres)
