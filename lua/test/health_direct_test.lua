...
describe("HealthDirect", function()
  it("should direct-load-health", function()
    local setup = health_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-health", setup.live and "live" or "unit")
...
function health_direct_setup(mockres)
  runner.load_env_local()

  local calls = {}

  local env = runner.env_override({
    ["HOOK__TEST_HEALTH_ENTID"] = {},
