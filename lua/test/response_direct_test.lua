...
describe("ResponseDirect", function()
  it("should direct-load-response", function()
    local setup = response_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-response", setup.live and "live" or "unit")
...
function response_direct_setup(mockres)
