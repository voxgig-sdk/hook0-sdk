...
describe("EventsPerDayEntryDirect", function()
  it("should direct-list-events_per_day_entry", function()
    local setup = events_per_day_entry_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-events_per_day_entry", setup.live and "live" or "unit")
...
function events_per_day_entry_direct_setup(mockres)
