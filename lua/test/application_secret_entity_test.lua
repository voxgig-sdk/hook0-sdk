...
describe("ApplicationSecretEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set HOOK__TEST_APPLICATION_SECRET_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    local application_secret_ref01_resdata_up0 = helpers.to_map(application_secret_ref01_resdata_up0_result)
...
function application_secret_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("HOOK__TEST_APPLICATION_SECRET_ENTID")
