...
describe("UserInvitationEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set HOOK__TEST_USER_INVITATION_ENTID JSON to run live")
      return
    end
...
function user_invitation_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("HOOK__TEST_USER_INVITATION_ENTID")
