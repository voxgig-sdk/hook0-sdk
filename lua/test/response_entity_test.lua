...
describe("ResponseEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set HOOK0_TEST_RESPONSE_ENTID JSON to run live")
      return
    end
...
function response_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("HOOK0_TEST_RESPONSE_ENTID")
