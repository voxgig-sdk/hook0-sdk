...
describe("ResponseEntity", function()
  it("should create instance", function()
    ...
    local ent = testsdk:Response(nil)
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set HOOK__TEST_RESPONSE_ENTID JSON to run live")
      return
    end
...
function response_basic_setup(extra)
  runner.load_env_local()

  local entity_data_file = _test_dir .. "../../.sdk/test/entity/response/ResponseTestData.json"
  local f = io.open(entity_data_file, "r")
  if f == nil then
    error("failed to read response test data: " .. entity_data_file)
  end
  ...
  local entid_env_raw = os.getenv("HOOK__TEST_RESPONSE_ENTID")
  local idmap_overridden = entid_env_raw ~= nil and entid_env_raw:match("^%s*{") ~= nil

  local env = runner.env_override({
    ["HOOK__TEST_RESPONSE_ENTID"] = idmap,
