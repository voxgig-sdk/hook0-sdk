...
describe("ProblemDirect", function()
  it("should direct-list-problem", function()
    local setup = problem_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-problem", setup.live and "live" or "unit")
...
function problem_direct_setup(mockres)
