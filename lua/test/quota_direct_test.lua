...
describe("QuotaDirect", function()
  it("should direct-load-quota", function()
    local setup = quota_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-quota", setup.live and "live" or "unit")
