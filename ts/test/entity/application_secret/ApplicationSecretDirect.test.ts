...
describe('ApplicationSecretDirect', async () => {
  ...
  test('direct-list-application_secret', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-application_secret', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['HOOK__TEST_APPLICATION_SECRET_ENTID']
