...
describe('EventsPerDayEntryDirect', async () => {
  ...
  test('direct-list-events_per_day_entry', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-events_per_day_entry', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['HOOK0_TEST_EVENTS_PER_DAY_ENTRY_ENTID']
