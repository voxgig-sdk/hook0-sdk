...
class ProblemEntity extends Hook0EntityBase_1.Hook0EntityBase {
    ...
    make() {
        return new ProblemEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Problem[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=ProblemEntity.js.map