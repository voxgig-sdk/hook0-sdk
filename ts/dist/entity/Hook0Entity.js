...
class Hook0Entity extends Hook0EntityBase_1.Hook0EntityBase {
    ...
    make() {
        return new Hook0Entity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Hook0[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.Hook0Entity = Hook0Entity;
//# sourceMappingURL=Hook0Entity.js.map