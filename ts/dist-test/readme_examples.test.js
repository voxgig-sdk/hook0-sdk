...
const TEST_SEED = { "entity": { "application": { "test01": { "id": "test01" } }, "application_secret": { "test01": { "id": "test01" } }, "applications_management": { "test01": { "id": "test01" } }, "event": { "test01": { "id": "test01" } }, "event_type": { "test01": { "id": "test01" } }, "events_management": { "test01": { "id": "test01" } }, "events_per_day_entry": { "test01": { "id": "test01" } }, "health": { "test01": { "id": "test01" } }, "hook0": { "test01": { "id": "test01" } }, "ingested_event": { "test01": { "id": "test01" } }, "instance": { "test01": { "id": "test01" } }, "login": { "test01": { "id": "test01" } }, "organization": { "test01": { "id": "test01" } }, "organization_edit_role": { "test01": { "id": "test01" } }, "problem": { "test01": { "id": "test01" } }, "quota": { "test01": { "id": "test01" } }, "registration": { "test01": { "id": "test01" } }, "request_attempt": { "test01": { "id": "test01" } }, "response": { "test01": { "id": "test01" } }, "revoke": { "test01": { "id": "test01" } }, "service_token": { "test01": { "id": "test01" } }, "subscription": { "test01": { "id": "test01" } }, "user_authentication": { "test01": { "id": "test01" } }, "user_invitation": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+Hook0SDK\b/.test(code) ||
        /\bHook0SDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+Hook0SDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/Hook0SDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
