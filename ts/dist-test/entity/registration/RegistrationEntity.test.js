...
(0, node_test_1.describe)('RegistrationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'registration.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['HOOK__TEST_REGISTRATION_ENTID'];
    ...
    idmap = env['HOOK__TEST_REGISTRATION_ENTID'];
