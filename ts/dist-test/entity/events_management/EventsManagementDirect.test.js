...
(0, node_test_1.describe)('EventsManagementDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-events_management', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-events_management', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK0_TEST_EVENTS_MANAGEMENT_ENTID'];
...
//# sourceMappingURL=EventsManagementDirect.test.js.map