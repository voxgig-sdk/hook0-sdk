...
(0, node_test_1.describe)('ApplicationSecretDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-application_secret', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-application_secret', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK0_TEST_APPLICATION_SECRET_ENTID'];
...
//# sourceMappingURL=ApplicationSecretDirect.test.js.map