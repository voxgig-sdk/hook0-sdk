...
(0, node_test_1.describe)('ResponseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-response', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-response', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK__TEST_RESPONSE_ENTID'];
...
//# sourceMappingURL=ResponseDirect.test.js.map