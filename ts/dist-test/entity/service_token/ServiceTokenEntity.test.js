...
(0, node_test_1.describe)('ServiceTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'list', 'update', 'load', 'remove']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'service_token.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != service_token_ref01_data);
        // LIST
        ...
        (0, node_assert_1.default)(null != service_token_ref01_resdata_up0);
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['HOOK__TEST_SERVICE_TOKEN_ENTID'];
