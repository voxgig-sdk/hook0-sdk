...
(0, node_test_1.describe)('RevokeEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'revoke.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/revoke/RevokeTestData.json');
    ...
    let idmap = transform(['revoke01', 'revoke02', 'revoke03', 'organization01', 'organization02', 'organization03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['HOOK__TEST_REVOKE_ENTID'];
    ...
    idmap = env['HOOK__TEST_REVOKE_ENTID'];
...
//# sourceMappingURL=RevokeEntity.test.js.map