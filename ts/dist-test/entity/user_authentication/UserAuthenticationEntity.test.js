...
(0, node_test_1.describe)('UserAuthenticationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'user_authentication.' + op, live))
                return;
        }
        ...
        user_authentication_ref01_data = await user_authentication_ref01_ent.create(user_authentication_ref01_data);
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['HOOK__TEST_USER_AUTHENTICATION_ENTID'];
    ...
    idmap = env['HOOK__TEST_USER_AUTHENTICATION_ENTID'];
