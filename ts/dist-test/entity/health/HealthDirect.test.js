...
(0, node_test_1.describe)('HealthDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-health', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-health', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK0_TEST_HEALTH_ENTID'];
...
//# sourceMappingURL=HealthDirect.test.js.map