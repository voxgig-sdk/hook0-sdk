...
(0, node_test_1.describe)('QuotaEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'quota.' + op, live))
                return;
        }
        ...
        const quota_ref01_data_dt0 = await quota_ref01_ent.load(quota_ref01_match_dt0);
        (0, node_assert_1.default)(null != quota_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['HOOK__TEST_QUOTA_ENTID'];
    ...
    idmap = env['HOOK__TEST_QUOTA_ENTID'];
