...
(0, node_test_1.describe)('QuotaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-quota', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-quota', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK0_TEST_QUOTA_ENTID'];
...
//# sourceMappingURL=QuotaDirect.test.js.map