...
(0, node_test_1.describe)('SubscriptionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-subscription', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-subscription', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-subscription', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-subscription', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK__TEST_SUBSCRIPTION_ENTID'];
...
//# sourceMappingURL=SubscriptionDirect.test.js.map