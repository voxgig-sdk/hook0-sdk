...
(0, node_test_1.describe)('ApplicationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-application', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-application', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-application', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-application', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK__TEST_APPLICATION_ENTID'];
...
//# sourceMappingURL=ApplicationDirect.test.js.map