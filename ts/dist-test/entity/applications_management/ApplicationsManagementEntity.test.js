...
(0, node_test_1.describe)('ApplicationsManagementEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of []) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'applications_management.' + op, live))
                return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['HOOK__TEST_APPLICATIONS_MANAGEMENT_ENTID'];
    ...
    idmap = env['HOOK__TEST_APPLICATIONS_MANAGEMENT_ENTID'];
