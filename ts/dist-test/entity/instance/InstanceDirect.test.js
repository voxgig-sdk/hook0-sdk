...
(0, node_test_1.describe)('InstanceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-instance', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-instance', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK__TEST_INSTANCE_ENTID'];
...
//# sourceMappingURL=InstanceDirect.test.js.map