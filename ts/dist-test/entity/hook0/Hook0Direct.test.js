...
(0, node_test_1.describe)('Hook0Direct', async () => {
    ...
    (0, node_test_1.test)('direct-list-hook0', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-hook0', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK0_TEST_HOOK0_ENTID'];
...
//# sourceMappingURL=Hook0Direct.test.js.map