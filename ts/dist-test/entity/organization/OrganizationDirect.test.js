...
(0, node_test_1.describe)('OrganizationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-organization', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-organization', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-organization', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-organization', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK__TEST_ORGANIZATION_ENTID'];
...
//# sourceMappingURL=OrganizationDirect.test.js.map