...
(0, node_test_1.describe)('ProblemDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-problem', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-problem', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK__TEST_PROBLEM_ENTID'];
...
//# sourceMappingURL=ProblemDirect.test.js.map