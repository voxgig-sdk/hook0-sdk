...
(0, node_test_1.describe)('EventTypeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-event_type', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-event_type', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-event_type', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-event_type', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK0_TEST_EVENT_TYPE_ENTID'];
...
//# sourceMappingURL=EventTypeDirect.test.js.map