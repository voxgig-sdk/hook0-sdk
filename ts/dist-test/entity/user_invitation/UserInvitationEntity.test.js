...
(0, node_test_1.describe)('UserInvitationEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'user_invitation.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != user_invitation_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/user_invitation/UserInvitationTestData.json');
    ...
    let idmap = transform(['user_invitation01', 'user_invitation02', 'user_invitation03', 'organization01', 'organization02', 'organization03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['HOOK__TEST_USER_INVITATION_ENTID'];
...
//# sourceMappingURL=UserInvitationEntity.test.js.map