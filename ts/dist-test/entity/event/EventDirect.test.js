...
(0, node_test_1.describe)('EventDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-event', async (t) => {
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HOOK0_TEST_EVENT_ENTID'];
...
//# sourceMappingURL=EventDirect.test.js.map