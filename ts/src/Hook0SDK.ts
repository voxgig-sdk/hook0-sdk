...
class Hook0SDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('Hook0SDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ApplicationSecret(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ApplicationsManagement(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  EventType(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  EventsManagement(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  EventsPerDayEntry(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Hook0(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  IngestedEvent(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Instance(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  OrganizationEditRole(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  RequestAttempt(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Revoke(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ServiceToken(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  UserAuthentication(entopts?: Record<string, any>) {
    const self = this
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  UserInvitation(entopts?: Record<string, any>) {
    const self = this
