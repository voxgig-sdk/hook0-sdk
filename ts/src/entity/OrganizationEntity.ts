...
class OrganizationEntity extends Hook0EntityBase<Organization> {
  ...
  async create(this: any, reqdata?: OrganizationCreateData, ctrl?: Control): Promise<Organization> {
  ...
  async update(this: any, reqdata?: OrganizationUpdateData, ctrl?: Control): Promise<Organization> {
  ...
  async remove(this: any, reqmatch?: OrganizationRemoveMatch, ctrl?: Control): Promise<Organization> {
