...
class OrganizationEntity extends Hook0EntityBase<Organization> {
  ...
  async load(this: any, reqmatch?: OrganizationLoadMatch, ctrl?: Control): Promise<OrganizationEntity> {
  ...
  async create(this: any, reqdata?: OrganizationCreateData, ctrl?: Control): Promise<OrganizationEntity> {
  ...
  async update(this: any, reqdata?: OrganizationUpdateData, ctrl?: Control): Promise<OrganizationEntity> {
  ...
  async remove(
    this: any, reqmatch?: OrganizationRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<OrganizationEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
