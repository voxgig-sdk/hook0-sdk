...
class ApplicationEntity extends Hook0EntityBase<Application> {
  ...
  async list(this: any, reqmatch?: ApplicationListMatch, ctrl?: Control): Promise<Application[]> {
  ...
  async update(this: any, reqdata?: ApplicationUpdateData, ctrl?: Control): Promise<Application> {
  ...
  async remove(this: any, reqmatch?: ApplicationRemoveMatch, ctrl?: Control): Promise<Application> {
