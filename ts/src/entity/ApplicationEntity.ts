...
class ApplicationEntity extends Hook0EntityBase<Application> {
  ...
  async load(this: any, reqmatch?: ApplicationLoadMatch, ctrl?: Control): Promise<ApplicationEntity> {
  ...
  async list(this: any, reqmatch?: ApplicationListMatch, ctrl?: Control): Promise<ApplicationEntity[]> {
  ...
  async create(this: any, reqdata?: ApplicationCreateData, ctrl?: Control): Promise<ApplicationEntity> {
  ...
  async update(this: any, reqdata?: ApplicationUpdateData, ctrl?: Control): Promise<ApplicationEntity> {
  ...
  async remove(
    this: any, reqmatch?: ApplicationRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ApplicationEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
