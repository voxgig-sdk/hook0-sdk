...
class ApplicationsManagementEntity extends Hook0EntityBase<ApplicationsManagement> {
  ...
  async remove(
    this: any, reqmatch?: ApplicationsManagementRemoveMatch, ctrl?: Control,
  ): Promise<ApplicationsManagementEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<ApplicationsManagementEntity> return stays clean under strict null checks.
