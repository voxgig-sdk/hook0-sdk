...
class EventsManagementEntity extends Hook0EntityBase<EventsManagement> {

  constructor(client: Hook0SDK, entopts: any) {
    super(client, entopts)
    this.name = 'events_management'
    this.name_ = 'events_management'
    this.Name = 'EventsManagement'
  }


  make(this: EventsManagementEntity) {
    return new EventsManagementEntity(this._client, this.entopts())
  }




  async list(this: any, reqmatch?: EventsManagementListMatch, ctrl?: Control): Promise<EventsManagementEntity[]> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<EventsManagement[]> return stays clean under strict null checks.
  ...
  async create(this: any, reqdata?: EventsManagementCreateData, ctrl?: Control): Promise<EventsManagementEntity> {
  ...
  async remove(
    this: any, reqmatch?: EventsManagementRemoveMatch, ctrl?: Control,
  ): Promise<EventsManagementEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<EventsManagementEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
