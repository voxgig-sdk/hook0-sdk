...
class ApplicationEntity extends Hook0EntityBase {
  ...
  /**
   * @param {ApplicationLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
  ...
  /**
   * @param {ApplicationListMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Application[]>}
   */
  ...
  /**
   * @param {ApplicationCreateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Application>}
   */
  ...
  /**
   * @param {ApplicationUpdateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Application>}
   */
  ...
  /**
   * @param {ApplicationRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Application>}
   */
