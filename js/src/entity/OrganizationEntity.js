...
class OrganizationEntity extends Hook0EntityBase {
  ...
  /**
   * @param {OrganizationLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
  ...
  /**
   * @param {OrganizationListMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Organization[]>}
   */
  ...
  /**
   * @param {OrganizationCreateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Organization>}
   */
  ...
  /**
   * @param {OrganizationUpdateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<Organization>}
   */
  ...
  /**
   * @param {OrganizationRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Organization>}
   */
