...
/** UserInvitation entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class UserInvitationEntity extends EntityBase {

  public UserInvitationEntity(SdkClient client, Map<String, Object> entopts) {
    super("user_invitation", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new UserInvitationEntity(this.client, opts);
  }
