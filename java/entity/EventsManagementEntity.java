...
/** EventsManagement entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class EventsManagementEntity extends EntityBase {

  public EventsManagementEntity(SdkClient client, Map<String, Object> entopts) {
    super("events_management", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new EventsManagementEntity(this.client, opts);
  }
