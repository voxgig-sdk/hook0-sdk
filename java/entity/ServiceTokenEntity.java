...
/** ServiceToken entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class ServiceTokenEntity extends EntityBase {

  public ServiceTokenEntity(SdkClient client, Map<String, Object> entopts) {
    super("service_token", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ServiceTokenEntity(this.client, opts);
  }
