...
/** EventType entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class EventTypeEntity extends EntityBase {

  public EventTypeEntity(SdkClient client, Map<String, Object> entopts) {
    super("event_type", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new EventTypeEntity(this.client, opts);
  }
