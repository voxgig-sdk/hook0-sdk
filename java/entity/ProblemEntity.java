...
/** Problem entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class ProblemEntity extends EntityBase {

  public ProblemEntity(SdkClient client, Map<String, Object> entopts) {
    super("problem", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ProblemEntity(this.client, opts);
  }
