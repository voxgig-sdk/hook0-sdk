...
/** Application entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class ApplicationEntity extends EntityBase {

  public ApplicationEntity(SdkClient client, Map<String, Object> entopts) {
    super("application", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ApplicationEntity(this.client, opts);
  }
