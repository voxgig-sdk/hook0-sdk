...
/** Registration entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class RegistrationEntity extends EntityBase {

  public RegistrationEntity(SdkClient client, Map<String, Object> entopts) {
    super("registration", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new RegistrationEntity(this.client, opts);
  }
