...
/** Event entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class EventEntity extends EntityBase {

  public EventEntity(SdkClient client, Map<String, Object> entopts) {
    super("event", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new EventEntity(this.client, opts);
  }
