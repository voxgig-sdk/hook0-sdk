...
/** Subscription entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class SubscriptionEntity extends EntityBase {

  public SubscriptionEntity(SdkClient client, Map<String, Object> entopts) {
    super("subscription", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new SubscriptionEntity(this.client, opts);
  }
