...
/** Response entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class ResponseEntity extends EntityBase {

  public ResponseEntity(SdkClient client, Map<String, Object> entopts) {
    super("response", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ResponseEntity(this.client, opts);
  }
