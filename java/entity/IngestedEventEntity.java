...
/** IngestedEvent entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class IngestedEventEntity extends EntityBase {

  public IngestedEventEntity(SdkClient client, Map<String, Object> entopts) {
    super("ingested_event", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new IngestedEventEntity(this.client, opts);
  }
