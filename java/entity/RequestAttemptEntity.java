...
/** RequestAttempt entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class RequestAttemptEntity extends EntityBase {

  public RequestAttemptEntity(SdkClient client, Map<String, Object> entopts) {
    super("request_attempt", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new RequestAttemptEntity(this.client, opts);
  }
