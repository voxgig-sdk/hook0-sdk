...
/** Login entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class LoginEntity extends EntityBase {

  public LoginEntity(SdkClient client, Map<String, Object> entopts) {
    super("login", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new LoginEntity(this.client, opts);
  }
