...
/** UserAuthentication entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class UserAuthenticationEntity extends EntityBase {

  public UserAuthenticationEntity(SdkClient client, Map<String, Object> entopts) {
    super("user_authentication", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new UserAuthenticationEntity(this.client, opts);
  }
