...
/** Health entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class HealthEntity extends EntityBase {

  public HealthEntity(SdkClient client, Map<String, Object> entopts) {
    super("health", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new HealthEntity(this.client, opts);
  }
