...
/** Organization entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class OrganizationEntity extends EntityBase {

  public OrganizationEntity(SdkClient client, Map<String, Object> entopts) {
    super("organization", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OrganizationEntity(this.client, opts);
  }
