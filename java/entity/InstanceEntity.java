...
/** Instance entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class InstanceEntity extends EntityBase {

  public InstanceEntity(SdkClient client, Map<String, Object> entopts) {
    super("instance", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new InstanceEntity(this.client, opts);
  }
