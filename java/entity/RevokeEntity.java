...
/** Revoke entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class RevokeEntity extends EntityBase {

  public RevokeEntity(SdkClient client, Map<String, Object> entopts) {
    super("revoke", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new RevokeEntity(this.client, opts);
  }
