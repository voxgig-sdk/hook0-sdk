...
/** OrganizationEditRole entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class OrganizationEditRoleEntity extends EntityBase {

  public OrganizationEditRoleEntity(SdkClient client, Map<String, Object> entopts) {
    super("organization_edit_role", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new OrganizationEditRoleEntity(this.client, opts);
  }
