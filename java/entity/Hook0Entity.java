...
/** Hook0 entity client for the Hook0 SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class Hook0Entity extends EntityBase {

  public Hook0Entity(SdkClient client, Map<String, Object> entopts) {
    super("hook0", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new Hook0Entity(this.client, opts);
  }
