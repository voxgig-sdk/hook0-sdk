...
from hook0_sdk.core.helpers import get_ctx_prop, to_map
...
class Hook0Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, Hook0Response):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return Hook0Error(code, msg, self)
