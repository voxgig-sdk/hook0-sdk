...
class ApplicationSecretUpdateDataRequired(TypedDict):
    id: str


class ApplicationSecretUpdateData(ApplicationSecretUpdateDataRequired, total=False):
    application_id: str
    created_at: str
    deleted_at: str
    name: str
...
class OrganizationEditRoleUpdateData(OrganizationEditRoleUpdateDataRequired, total=False):
    role: str
    user_id: str
...
class ServiceTokenUpdateData(ServiceTokenUpdateDataRequired, total=False):
    biscuit: str
    created_at: str
    name: str
    organization_id: str
