...
class UserAuthenticationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserAuthenticationEntity(self._client, opts)
    ...
    def data_get(self) -> UserAuthentication:
    ...
    def match_get(self) -> UserAuthentication:
    ...
    def create(self, reqdata: UserAuthenticationCreateData, ctrl=None) -> UserAuthentication:
        utility = self._utility
