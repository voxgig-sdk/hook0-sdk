...
class Hook0Entity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return Hook0Entity(self._client, opts)
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Hook0]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Hook0().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
