...
class ApplicationSecretEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApplicationSecretEntity(self._client, opts)
    ...
    def data_get(self) -> ApplicationSecret:
    ...
    def match_get(self) -> ApplicationSecret:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ApplicationSecret]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ApplicationSecret().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ApplicationSecretCreateData, ctrl=None) -> ApplicationSecret:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ApplicationSecretUpdateData, ctrl=None) -> ApplicationSecret:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
