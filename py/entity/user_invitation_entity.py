...
class UserInvitationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UserInvitationEntity(self._client, opts)
    ...
    def data_get(self) -> UserInvitation:
    ...
    def match_get(self) -> UserInvitation:
    ...
    def create(self, reqdata: UserInvitationCreateData, ctrl=None) -> UserInvitation:
        utility = self._utility
