...
class IngestedEventEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IngestedEventEntity(self._client, opts)
    ...
    def data_get(self) -> IngestedEvent:
    ...
    def match_get(self) -> IngestedEvent:
    ...
    def create(self, reqdata: IngestedEventCreateData, ctrl=None) -> IngestedEvent:
        utility = self._utility
