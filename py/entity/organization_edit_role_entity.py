...
class OrganizationEditRoleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return OrganizationEditRoleEntity(self._client, opts)
    ...
    def data_get(self) -> OrganizationEditRole:
    ...
    def match_get(self) -> OrganizationEditRole:
    ...
    def update(self, reqdata: OrganizationEditRoleUpdateData, ctrl=None) -> OrganizationEditRole:
        utility = self._utility
