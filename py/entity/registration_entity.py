...
class RegistrationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RegistrationEntity(self._client, opts)
    ...
    def data_get(self) -> Registration:
    ...
    def match_get(self) -> Registration:
    ...
    def create(self, reqdata: RegistrationCreateData, ctrl=None) -> Registration:
        utility = self._utility
