# Hook0 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions Hook0SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both Hook0SDK(...) and Hook0SDK.test(...) become
#      Hook0SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_ENTITIES = {
    ...
    "ApplicationsManagement": "applications_management",
    "Event": "event",
    ...
    "OrganizationEditRole": "organization_edit_role",
    "Problem": "problem",
    "Quota": "quota",
