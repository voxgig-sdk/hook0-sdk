    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set HOOK__TEST_ORGANIZATION_ENTID JSON to run live")
        client = setup["client"]
        ...
        organization_ref01_data = helpers.to_map(organization_ref01_ent.create(organization_ref01_data, None))
        ...
        organization_ref01_resdata_up0 = helpers.to_map(organization_ref01_ent.update(organization_ref01_data_up0_up, None))
...
def _organization_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("HOOK__TEST_ORGANIZATION_ENTID"))
