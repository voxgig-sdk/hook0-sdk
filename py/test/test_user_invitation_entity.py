    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set HOOK__TEST_USER_INVITATION_ENTID JSON to run live")
        client = setup["client"]
        ...
        user_invitation_ref01_data = helpers.to_map(user_invitation_ref01_ent.create(user_invitation_ref01_data, None))
...
def _user_invitation_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "HOOK__TEST_USER_INVITATION_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("HOOK__TEST_USER_INVITATION_ENTID"))
