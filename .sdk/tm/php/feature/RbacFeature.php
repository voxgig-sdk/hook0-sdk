...
class Hook0RbacFeature extends Hook0BaseFeature
{
    ...
    private function _required(Hook0Context $ctx): ?string
    {
    ...
    private function _reject(Hook0Context $ctx, string $required): void
    {
    ...
    private function _track(Hook0Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
