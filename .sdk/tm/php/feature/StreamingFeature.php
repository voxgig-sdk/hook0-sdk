...
class Hook0StreamingFeature extends Hook0BaseFeature
{
    ...
    private function _iterate(Hook0Result $result): \Generator
    {
    ...
    private function _streamable(Hook0Context $ctx): bool
    {
