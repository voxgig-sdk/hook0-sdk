...
class Hook0ProxyFeature extends Hook0BaseFeature
{
    ...
    public function init(Hook0Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (Hook0Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
