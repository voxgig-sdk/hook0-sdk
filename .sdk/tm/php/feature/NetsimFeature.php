...
class Hook0NetsimFeature extends Hook0BaseFeature
{
    ...
    private function _simulate(Hook0Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(Hook0Context $ctx, array $applied): void
    {
        $client = $this->client;
