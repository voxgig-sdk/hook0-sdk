...
// Hook0 SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class Hook0Param
{
    public static function call(Hook0Context $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = Hook0Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
