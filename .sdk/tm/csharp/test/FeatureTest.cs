...
internal static class Fh
{
    ...
    {
        var client = Hook0SDK.TestSDK(null, null);
    ...
    {
        return err is Hook0Error se ? se.Code : "";
    }
}
...
public class FeaturePagingTest
{
    ...
    public void StampsPageLimitAndReadsHeaders()
    {
        ...
        Assert.Equal(2, Hook0Sdk.Helpers.ToInt(paging["nextPage"]));
        Assert.Equal(5, Hook0Sdk.Helpers.ToInt(paging["totalCount"]));
