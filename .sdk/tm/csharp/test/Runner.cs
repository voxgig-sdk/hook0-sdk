// Hook0 SDK test runner - shared infrastructure for the generated
...
public static class TestRunner
{
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = Hook0Sdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
        ...
        Hook0SDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new Hook0Error("", msg, null);
            }
        }
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new Hook0Error(code, msg, null);
    }
