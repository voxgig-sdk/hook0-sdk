...
public class PipelineTest
{
    ...
    private static (Hook0SDK, Utility) PlClient(Dictionary<string, object?>? sdkopts)
    {
        var client = Hook0SDK.TestSDK(null, sdkopts);
        return (client, client.GetUtility());
    }

    private static Context PlCtx(Hook0SDK client, Utility utility,
    ...
    private static Utility UtilWith(Hook0SDK client, FetcherFunc fetcher)
    {
    ...
    public void MakeRequestTransportErrorCarriedOnResponse()
    {
        ...
        Assert.True(resp.Err is Hook0Error pe && pe.Code == "boom",
