...
public class PrimaryUtilityTest
{
    ...
    private readonly Hook0SDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = Hook0SDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(Hook0SDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(Hook0SDK client, Utility utility)
    {
    ...
    {
        var hookClient = Hook0SDK.TestSDK(null, null);
    ...
    {
        var initClient = Hook0SDK.TestSDK(null, null);
    ...
    public void FetcherLive()
    {
        ...
        var liveClient = new Hook0SDK(new Dictionary<string, object?>
        {
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new Hook0SDK(new Dictionary<string, object?>
        {
            ["system"] = new Dictionary<string, object?>
            {
                ["fetch"] = (Func<string, Dictionary<string, object?>, Dictionary<string, object?>>)
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = Hook0SDK.TestSDK(null, setupOpts);
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = Hook0SDK.TestSDK(null, setupOpts);
