// Hook0 SDK - shared value helpers for the loose object model.
//
...
// does not define.
func unsupportedOp(_ opname: String, _ entityname: String) -> Hook0Error {
  return Hook0Error(
    "unsupported_op",
...
func errMessage(_ e: Error) -> String {
  if let se = e as? Hook0Error { return se.message }
