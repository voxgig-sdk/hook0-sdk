...
public final class Context {
  ...
  public init(_ ctxmap: [String: Any?]?, _ basectx: Context?) {
    ...
    // Client
    if let sdk = ctxProp(ctxmap, "client") as? Hook0SDK { client = sdk }
  ...
  public func makeError(_ code: String, _ msg: String) -> Hook0Error {
