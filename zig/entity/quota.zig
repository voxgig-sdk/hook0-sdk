// Quota entity client (generated — mirrors the go/rust Entity fragment).
...
pub const QuotaEntity = struct {
    ...
    pub fn new(client: *sdk.Hook0SDK, entopts_in: Value) *QuotaEntity {
        ...
        const e = h.A().create(QuotaEntity) catch unreachable;
        e.* = .{
            .name = "quota",
            .client = client,
    ...
    fn ent_ctx(self: *QuotaEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *QuotaEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *QuotaEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *QuotaEntity, ctx: *Context, post_done: *const fn (*QuotaEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *QuotaEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *QuotaEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *QuotaEntity, ctx: *Context, post_done: *const fn (*QuotaEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *QuotaEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *QuotaEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return QuotaEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *QuotaEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *QuotaEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *QuotaEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *QuotaEntity, reqmatch: Value, ctrl: Value) EntResult {
    ...
    fn load_post_done(self: *QuotaEntity, ctx: *Context) void {
    ...
    pub fn list(self: *QuotaEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("list", self.name) };
    }

    pub fn create(self: *QuotaEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("create", self.name) };
    }

    pub fn update(self: *QuotaEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *QuotaEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
