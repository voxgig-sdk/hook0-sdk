// ApplicationsManagement entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EntResult = union(enum) {
    ok: *ApplicationsManagementEntity,
...
pub const ApplicationsManagementEntity = struct {
    name: []const u8 = "applications_management",
    client: *sdk.Hook0SDK,
    utility: *Utility,
    entopts: Value,
    data: Value,
    ...
    pub fn new(client: *sdk.Hook0SDK, entopts_in: Value) *ApplicationsManagementEntity {
        ...
        const e = h.A().create(ApplicationsManagementEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *ApplicationsManagementEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *ApplicationsManagementEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *ApplicationsManagementEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *ApplicationsManagementEntity, ctx: *Context, post_done: *const fn (*ApplicationsManagementEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *ApplicationsManagementEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *ApplicationsManagementEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *ApplicationsManagementEntity, ctx: *Context, post_done: *const fn (*ApplicationsManagementEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *ApplicationsManagementEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *ApplicationsManagementEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return ApplicationsManagementEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *ApplicationsManagementEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *ApplicationsManagementEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *ApplicationsManagementEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *ApplicationsManagementEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *ApplicationsManagementEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("list", self.name) };
    }

    pub fn create(self: *ApplicationsManagementEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("create", self.name) };
    }

    pub fn update(self: *ApplicationsManagementEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
    ...
    pub fn remove(self: *ApplicationsManagementEntity, reqmatch: Value, ctrl: Value) EntResult {
    ...
    fn remove_post_done(self: *ApplicationsManagementEntity, ctx: *Context) void {
