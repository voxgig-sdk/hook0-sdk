// UserInvitation entity client (generated — mirrors the go/rust Entity fragment).
...
pub const UserInvitationEntity = struct {
    name: []const u8 = "user_invitation",
    client: *sdk.Hook0SDK,
    utility: *Utility,
    entopts: Value,
    data: Value,
    ...
    pub fn new(client: *sdk.Hook0SDK, entopts_in: Value) *UserInvitationEntity {
        ...
        const e = h.A().create(UserInvitationEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *UserInvitationEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *UserInvitationEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *UserInvitationEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *UserInvitationEntity, ctx: *Context, post_done: *const fn (*UserInvitationEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *UserInvitationEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *UserInvitationEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *UserInvitationEntity, ctx: *Context, post_done: *const fn (*UserInvitationEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *UserInvitationEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *UserInvitationEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return UserInvitationEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *UserInvitationEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *UserInvitationEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *UserInvitationEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *UserInvitationEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *UserInvitationEntity, _reqmatch: Value, _ctrl: Value) EntListResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *UserInvitationEntity, reqdata: Value, ctrl: Value) EntResult {
    ...
    fn create_post_done(self: *UserInvitationEntity, ctx: *Context) void {
    ...
    pub fn update(self: *UserInvitationEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *UserInvitationEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
