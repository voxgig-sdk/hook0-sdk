// EventsPerDayEntry entity client (generated — mirrors the go/rust Entity fragment).
...
pub const EventsPerDayEntryEntity = struct {
    name: []const u8 = "events_per_day_entry",
    client: *sdk.Hook0SDK,
    utility: *Utility,
    entopts: Value,
    data: Value,
    ...
    pub fn new(client: *sdk.Hook0SDK, entopts_in: Value) *EventsPerDayEntryEntity {
        ...
        const e = h.A().create(EventsPerDayEntryEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *EventsPerDayEntryEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *EventsPerDayEntryEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *EventsPerDayEntryEntity, ctx: *Context) OpResult {
    ...
    fn run_op_ent(self: *EventsPerDayEntryEntity, ctx: *Context, post_done: *const fn (*EventsPerDayEntryEntity, *Context) void) EntResult {
    ...
    // live record.
    pub fn mark_deleted(self: *EventsPerDayEntryEntity) void {
        self.deleted = true;
    }

    pub fn is_deleted(self: *EventsPerDayEntryEntity) bool {
        return self.deleted;
    }

    fn run_op(self: *EventsPerDayEntryEntity, ctx: *Context, post_done: *const fn (*EventsPerDayEntryEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *EventsPerDayEntryEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *EventsPerDayEntryEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return EventsPerDayEntryEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *EventsPerDayEntryEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *EventsPerDayEntryEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *EventsPerDayEntryEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *EventsPerDayEntryEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn list(self: *EventsPerDayEntryEntity, reqmatch: Value, ctrl: Value) EntListResult {
        ...
        var items = std.ArrayList(*EventsPerDayEntryEntity).init(h.A());
        if (out == .array) {
            for (out.array.data.items) |entry| {
                const ent = EventsPerDayEntryEntity.new(self.client, h.clone(self.entopts));
                if (entry == .object) {
        ...
        return EntListResult{ .ok = items.toOwnedSlice() catch &[_]*EventsPerDayEntryEntity{} };
    }
    
    fn list_post_done(self: *EventsPerDayEntryEntity, ctx: *Context) void {
    ...
    pub fn create(self: *EventsPerDayEntryEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("create", self.name) };
    }

    pub fn update(self: *EventsPerDayEntryEntity, _reqdata: Value, _ctrl: Value) EntResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *EventsPerDayEntryEntity, _reqmatch: Value, _ctrl: Value) EntResult {
        _ = _reqmatch;
        _ = _ctrl;
