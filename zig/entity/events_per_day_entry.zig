...
pub const EventsPerDayEntryEntity = struct {
    ...
    pub fn load(self: *EventsPerDayEntryEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn list(self: *EventsPerDayEntryEntity, reqmatch: Value, ctrl: Value) OpResult {
    ...
    pub fn create(self: *EventsPerDayEntryEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("create", self.name) };
    }

    pub fn update(self: *EventsPerDayEntryEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *EventsPerDayEntryEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
