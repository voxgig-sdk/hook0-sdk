...
class InstanceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InstanceEntity($this->_client, $opts);
    }

    /**
     * @param Instance|array $args Instance data (assoc-array) to store.
     */
    ...
    /**
     * @return Instance|array The current Instance data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Instance fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Instance fields).
     */
     ...
     *
     * @param InstanceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InstanceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Instance|array The loaded Instance as an assoc-array at the
