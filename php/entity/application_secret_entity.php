...
// Hook0 SDK ApplicationSecret entity
...
class ApplicationSecretEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApplicationSecretEntity($this->_client, $opts);
    }

    /**
     * @param ApplicationSecret|array $args ApplicationSecret data (assoc-array) to store.
     */
    ...
    /**
     * @return ApplicationSecret|array The current ApplicationSecret data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApplicationSecret fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApplicationSecret fields).
     */
    ...
    /**
     * List ApplicationSecret items matching the given filter.
     *
     * @param ApplicationSecretListMatch|array|null $reqmatch Match filter (any subset
     *   of ApplicationSecret fields) as an assoc-array; ApplicationSecretListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApplicationSecret[]|array A list of ApplicationSecret items as assoc-arrays at
     ...
     *
     * @param ApplicationSecretCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApplicationSecretCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApplicationSecret|array The created ApplicationSecret as an assoc-array at the
    ...
    /**
     * Update an existing ApplicationSecret.
     *
     * @param ApplicationSecretUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApplicationSecretUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApplicationSecret|array The updated ApplicationSecret as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
