...
// Hook0 SDK EventsPerDayEntry entity
...
class EventsPerDayEntryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "events_per_day_entry";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new EventsPerDayEntryEntity($this->_client, $opts);
    }

    /**
     * @param EventsPerDayEntry|array $args EventsPerDayEntry data (assoc-array) to store.
     */
    ...
    /**
     * @return EventsPerDayEntry|array The current EventsPerDayEntry data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EventsPerDayEntry fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EventsPerDayEntry fields).
     */
    ...
    /**
     * List EventsPerDayEntry items matching the given filter.
     *
     * @param EventsPerDayEntryListMatch|array|null $reqmatch Match filter (any subset
     *   of EventsPerDayEntry fields) as an assoc-array; EventsPerDayEntryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EventsPerDayEntry[]|array A list of EventsPerDayEntry items as assoc-arrays at
