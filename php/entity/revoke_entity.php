...
class RevokeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RevokeEntity($this->_client, $opts);
    }

    /**
     * @param Revoke|array $args Revoke data (assoc-array) to store.
     */
    ...
    /**
     * @return Revoke|array The current Revoke data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Revoke fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Revoke fields).
     */
    ...
    /**
     * Remove an Revoke matching the given criteria.
     *
     * @param RevokeRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; RevokeRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Revoke|array The removed Revoke as an assoc-array at the
