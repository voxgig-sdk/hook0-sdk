...
class UserAuthenticationEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "user_authentication";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new UserAuthenticationEntity($this->_client, $opts);
    }

    /**
     * @param UserAuthentication|array $args UserAuthentication data (assoc-array) to store.
     */
    ...
    /**
     * @return UserAuthentication|array The current UserAuthentication data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserAuthentication fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserAuthentication fields).
     */
    ...
    /**
     * Create a new UserAuthentication.
     *
     * @param UserAuthenticationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UserAuthenticationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserAuthentication|array The created UserAuthentication as an assoc-array at the
