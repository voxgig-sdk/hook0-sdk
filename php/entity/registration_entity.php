...
class RegistrationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RegistrationEntity($this->_client, $opts);
    }

    /**
     * @param Registration|array $args Registration data (assoc-array) to store.
     */
    ...
    /**
     * @return Registration|array The current Registration data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Registration fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Registration fields).
     */
     ...
     *
     * @param RegistrationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RegistrationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Registration|array The created Registration as an assoc-array at the
