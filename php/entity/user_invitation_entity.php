...
class UserInvitationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UserInvitationEntity($this->_client, $opts);
    }

    /**
     * @param UserInvitation|array $args UserInvitation data (assoc-array) to store.
     */
    ...
    /**
     * @return UserInvitation|array The current UserInvitation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UserInvitation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UserInvitation fields).
     */
     ...
     *
     * @param UserInvitationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UserInvitationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UserInvitation|array The created UserInvitation as an assoc-array at the
