...
class LoginEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LoginEntity($this->_client, $opts);
    }

    /**
     * @param Login|array $args Login data (assoc-array) to store.
     */
    ...
    /**
     * @return Login|array The current Login data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Login fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Login fields).
     */
     ...
     * Create a new Login.
     *
     * @param LoginCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LoginCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Login|array The created Login as an assoc-array at the
