...
class OrganizationEditRoleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "organization_edit_role";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new OrganizationEditRoleEntity($this->_client, $opts);
    }

    /**
     * @param OrganizationEditRole|array $args OrganizationEditRole data (assoc-array) to store.
     */
    ...
    /**
     * @return OrganizationEditRole|array The current OrganizationEditRole data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of OrganizationEditRole fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of OrganizationEditRole fields).
     */
    ...
    /**
     * Update an existing OrganizationEditRole.
     *
     * @param OrganizationEditRoleUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationEditRoleUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return OrganizationEditRole|array The updated OrganizationEditRole as an assoc-array at the
