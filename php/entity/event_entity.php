...
class EventEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EventEntity($this->_client, $opts);
    }

    /**
     * @param Event|array $args Event data (assoc-array) to store.
     */
    ...
    /**
     * @return Event|array The current Event data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Event fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Event fields).
     */
     ...
     * Load a single Event.
     *
     * @param EventLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EventLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Event|array The loaded Event as an assoc-array at the
    ...
    /**
     * List Event items matching the given filter.
     *
     * @param EventListMatch|array|null $reqmatch Match filter (any subset
     *   of Event fields) as an assoc-array; EventListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Event[]|array A list of Event items as assoc-arrays at
