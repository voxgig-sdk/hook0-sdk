...
class ApplicationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApplicationEntity($this->_client, $opts);
    }

    /**
     * @param Application|array $args Application data (assoc-array) to store.
     */
    ...
    /**
     * @return Application|array The current Application data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Application fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Application fields).
     */
     ...
     *
     * @param ApplicationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApplicationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Application|array The loaded Application as an assoc-array at the
    ...
    /**
     * List Application items matching the given filter.
     *
     * @param ApplicationListMatch|array|null $reqmatch Match filter (any subset
     *   of Application fields) as an assoc-array; ApplicationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Application[]|array A list of Application items as assoc-arrays at
     ...
     *
     * @param ApplicationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApplicationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Application|array The created Application as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
     ...
     *
     * @param ApplicationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApplicationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Application|array The updated Application as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Application matching the given criteria.
     *
     * @param ApplicationRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ApplicationRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Application|array The removed Application as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
