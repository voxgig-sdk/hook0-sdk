...
class IngestedEventEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IngestedEventEntity($this->_client, $opts);
    }

    /**
     * @param IngestedEvent|array $args IngestedEvent data (assoc-array) to store.
     */
    ...
    /**
     * @return IngestedEvent|array The current IngestedEvent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IngestedEvent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IngestedEvent fields).
     */
    ...
    /**
     * Create a new IngestedEvent.
     *
     * @param IngestedEventCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IngestedEventCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IngestedEvent|array The created IngestedEvent as an assoc-array at the
