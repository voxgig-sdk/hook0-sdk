...
class OrganizationEntity
{
     ...
     *
     * @param OrganizationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Organization|array The created Organization as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
     ...
     *
     * @param OrganizationUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed OrganizationUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Organization|array The updated Organization as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Organization matching the given criteria.
     *
     * @param OrganizationRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; OrganizationRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Organization|array The removed Organization as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
