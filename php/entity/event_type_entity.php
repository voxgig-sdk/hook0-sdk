...
class EventTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EventTypeEntity($this->_client, $opts);
    }

    /**
     * @param EventType|array $args EventType data (assoc-array) to store.
     */
    ...
    /**
     * @return EventType|array The current EventType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EventType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EventType fields).
     */
    ...
    /**
     * Load a single EventType.
     *
     * @param EventTypeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EventTypeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EventType|array The loaded EventType as an assoc-array at the
    ...
    /**
     * List EventType items matching the given filter.
     *
     * @param EventTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of EventType fields) as an assoc-array; EventTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EventType[]|array A list of EventType items as assoc-arrays at
     ...
     *
     * @param EventTypeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EventTypeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EventType|array The created EventType as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
