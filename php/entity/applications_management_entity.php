...
class ApplicationsManagementEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "applications_management";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApplicationsManagementEntity($this->_client, $opts);
    }

    /**
     * @param ApplicationsManagement|array $args ApplicationsManagement data (assoc-array) to store.
     */
    ...
    /**
     * @return ApplicationsManagement|array The current ApplicationsManagement data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApplicationsManagement fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApplicationsManagement fields).
     */
    ...
    /**
     * Remove an ApplicationsManagement matching the given criteria.
     *
     * @param ApplicationsManagementRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ApplicationsManagementRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApplicationsManagement|array The removed ApplicationsManagement as an assoc-array at the
