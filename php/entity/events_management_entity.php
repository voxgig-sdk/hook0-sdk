...
// Hook0 SDK EventsManagement entity
...
class EventsManagementEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EventsManagementEntity($this->_client, $opts);
    }

    /**
     * @param EventsManagement|array $args EventsManagement data (assoc-array) to store.
     */
    ...
    /**
     * @return EventsManagement|array The current EventsManagement data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EventsManagement fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EventsManagement fields).
     */
    ...
    /**
     * List EventsManagement items matching the given filter.
     *
     * @param EventsManagementListMatch|array|null $reqmatch Match filter (any subset
     *   of EventsManagement fields) as an assoc-array; EventsManagementListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EventsManagement[]|array A list of EventsManagement items as assoc-arrays at
    ...
    /**
     * Remove an EventsManagement matching the given criteria.
     *
     * @param EventsManagementRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; EventsManagementRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EventsManagement|array The removed EventsManagement as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
