...
class Hook0Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new Hook0Entity($this->_client, $opts);
    }

    /**
     * @param Hook0|array $args Hook0 data (assoc-array) to store.
     */
    ...
    /**
     * @return Hook0|array The current Hook0 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Hook0 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Hook0 fields).
     */
    ...
    /**
     * List Hook0 items matching the given filter.
     *
     * @param Hook0ListMatch|array|null $reqmatch Match filter (any subset
     *   of Hook0 fields) as an assoc-array; Hook0ListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Hook0[]|array A list of Hook0 items as assoc-arrays at
