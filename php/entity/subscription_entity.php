...
class SubscriptionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SubscriptionEntity($this->_client, $opts);
    }

    /**
     * @param Subscription|array $args Subscription data (assoc-array) to store.
     */
    ...
    /**
     * @return Subscription|array The current Subscription data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Subscription fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Subscription fields).
     */
     ...
     *
     * @param SubscriptionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SubscriptionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Subscription|array The loaded Subscription as an assoc-array at the
    ...
    /**
     * List Subscription items matching the given filter.
     *
     * @param SubscriptionListMatch|array|null $reqmatch Match filter (any subset
     *   of Subscription fields) as an assoc-array; SubscriptionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Subscription[]|array A list of Subscription items as assoc-arrays at
     ...
     *
     * @param SubscriptionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SubscriptionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Subscription|array The created Subscription as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
     ...
     *
     * @param SubscriptionUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SubscriptionUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Subscription|array The updated Subscription as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Subscription matching the given criteria.
     *
     * @param SubscriptionRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SubscriptionRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Subscription|array The removed Subscription as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
