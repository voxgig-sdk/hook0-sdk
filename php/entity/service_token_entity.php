...
class ServiceTokenEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ServiceTokenEntity($this->_client, $opts);
    }

    /**
     * @param ServiceToken|array $args ServiceToken data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = Hook0Helpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return ServiceToken|array The current ServiceToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ServiceToken fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = Hook0Helpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of ServiceToken fields).
     */
    ...
    /**
     * Load a single ServiceToken.
     *
     * @param ServiceTokenLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ServiceTokenLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ServiceToken|array The loaded ServiceToken as an assoc-array at the
    ...
    /**
     * List ServiceToken items matching the given filter.
     *
     * @param ServiceTokenListMatch|array|null $reqmatch Match filter (any subset
     *   of ServiceToken fields) as an assoc-array; ServiceTokenListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ServiceToken[]|array A list of ServiceToken items as assoc-arrays at
     *   the SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
    ...
    /**
     * Create a new ServiceToken.
     *
     * @param ServiceTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ServiceTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ServiceToken|array The created ServiceToken as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ServiceToken.
     *
     * @param ServiceTokenUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ServiceTokenUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ServiceToken|array The updated ServiceToken as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ServiceToken matching the given criteria.
     *
     * @param ServiceTokenRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ServiceTokenRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ServiceToken|array The removed ServiceToken as an assoc-array at the
     *   SDK boundary; throws Hook0Error on failure (item-5 convention).
     */
