...
// Hook0 SDK RequestAttempt entity
...
class RequestAttemptEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RequestAttemptEntity($this->_client, $opts);
    }

    /**
     * @param RequestAttempt|array $args RequestAttempt data (assoc-array) to store.
     */
    ...
    /**
     * @return RequestAttempt|array The current RequestAttempt data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RequestAttempt fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RequestAttempt fields).
     */
    ...
    /**
     * Load a single RequestAttempt.
     *
     * @param RequestAttemptLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RequestAttemptLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RequestAttempt|array The loaded RequestAttempt as an assoc-array at the
    ...
    /**
     * List RequestAttempt items matching the given filter.
     *
     * @param RequestAttemptListMatch|array|null $reqmatch Match filter (any subset
     *   of RequestAttempt fields) as an assoc-array; RequestAttemptListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RequestAttempt[]|array A list of RequestAttempt items as assoc-arrays at
