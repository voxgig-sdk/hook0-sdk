...
class HealthEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new HealthEntity($this->_client, $opts);
    }

    /**
     * @param Health|array $args Health data (assoc-array) to store.
     */
    ...
    /**
     * @return Health|array The current Health data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Health fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Health fields).
     */
    ...
    /**
     * Load a single Health.
     *
     * @param HealthLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed HealthLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Health|array The loaded Health as an assoc-array at the
