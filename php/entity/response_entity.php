...
class ResponseEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ResponseEntity($this->_client, $opts);
    }

    /**
     * @param Response|array $args Response data (assoc-array) to store.
     */
    ...
    /**
     * @return Response|array The current Response data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Response fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Response fields).
     */
     ...
     *
     * @param ResponseLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ResponseLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Response|array The loaded Response as an assoc-array at the
