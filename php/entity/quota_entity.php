...
class QuotaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new QuotaEntity($this->_client, $opts);
    }

    /**
     * @param Quota|array $args Quota data (assoc-array) to store.
     */
    ...
    /**
     * @return Quota|array The current Quota data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Quota fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Quota fields).
     */
     ...
     * Load a single Quota.
     *
     * @param QuotaLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed QuotaLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Quota|array The loaded Quota as an assoc-array at the
