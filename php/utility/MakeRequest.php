...
// Hook0 SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class Hook0MakeRequest
{
    public static function call(Hook0Context $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new Hook0Response(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new Hook0Response($fetched);
        } else {
