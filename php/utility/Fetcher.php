...
class Hook0Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; Hook0SDK/1.0)';
    ...
    public static function call(Hook0Context $ctx, string $fullurl, array $fetchdef): array
    {
