...
class OrganizationEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->Organization(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Organization(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HOOK__TEST_ORGANIZATION_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $organization_ref01_resdata_up0 = Helpers::to_map($organization_ref01_resdata_up0_result);
...
function organization_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HOOK__TEST_ORGANIZATION_ENTID");
