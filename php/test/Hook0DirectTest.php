...
class Hook0DirectTest extends TestCase
{
    public function test_direct_list_hook0(): void
    {
        $setup = hook0_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-hook0", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
