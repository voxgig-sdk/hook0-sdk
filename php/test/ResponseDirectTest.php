...
class ResponseDirectTest extends TestCase
{
    public function test_direct_load_response(): void
    {
        $setup = response_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-response", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
