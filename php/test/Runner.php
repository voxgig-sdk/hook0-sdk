...
class Hook0TestRunner
{
    ...
    {
        $live = self::getenv('HOOK0_TEST_LIVE');
        $override = self::getenv('HOOK0_TEST_OVERRIDE');
        ...
        $explain = self::getenv('HOOK0_TEST_EXPLAIN');
...
class_alias('Hook0TestRunner', 'Runner');
class_alias('Hook0Helpers', 'Helpers');
