...
// Hook0 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (Hook0SDK::test)
...
{
    private const SDK_CLASS = 'Hook0SDK';
    ...
    private const SDK_BASE = 'hook0_sdk';
