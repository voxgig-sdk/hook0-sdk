...
class QuotaEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HOOK__TEST_QUOTA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function quota_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HOOK__TEST_QUOTA_ENTID");
