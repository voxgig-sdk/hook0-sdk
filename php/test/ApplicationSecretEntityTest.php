...
class ApplicationSecretEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HOOK0_TEST_APPLICATION_SECRET_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function application_secret_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HOOK0_TEST_APPLICATION_SECRET_ENTID");
