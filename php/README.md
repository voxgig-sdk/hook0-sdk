...
| `quotas` | `array` | Quota limits for this application. |
...
| `labels` | `array` | Labels for event filtering and routing to subscriptions. |
| `metadata` | `array` | Optional metadata key-value pairs associated with the event. |
...
| `response_id` | `string` |  |
| `retry_count` | `int` |  |
| `status` | `array` | Status of a request attempt. |
| `subscription` | `array` |  |
| `succeeded_at` | `string` |  |
