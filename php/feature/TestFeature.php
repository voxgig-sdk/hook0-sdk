...
// Hook0 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class Hook0TestFeature extends Hook0BaseFeature
{
    ...
    public function init(Hook0Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (Hook0Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (Hook0Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(Hook0Context $ctx, $op, $args): array
    {
