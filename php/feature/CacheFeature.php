...
class Hook0CacheFeature extends Hook0BaseFeature
{
    ...
    private function _through(Hook0Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
