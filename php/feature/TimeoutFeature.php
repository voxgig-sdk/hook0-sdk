...
class Hook0TimeoutFeature extends Hook0BaseFeature
{
    ...
    private function _with_timeout(Hook0Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(Hook0Context $_ctx, float $ms): void
    {
        $client = $this->client;
