...
class Hook0ClienttrackFeature extends Hook0BaseFeature
{
    ...
    public function PostConstruct(Hook0Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Hook0-SDK';
