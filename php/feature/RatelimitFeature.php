...
class Hook0RatelimitFeature extends Hook0BaseFeature
{
    ...
    private function _acquire(Hook0Context $ctx): void
    {
    ...
    private function _track(Hook0Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
